...
import { mockEvents, mockMembers, mockAttendance } from '@/lib/mock/data';
...
export function AttendanceSection() {
  ...
  const upcomingEvents = mockEvents.filter(e => new Date(e.date) >= new Date() && e.enableAttendance);
  ...
  const stats = [
    { label: 'Present', value: Object.values(attendance).filter(Boolean).length, color: 'text-green-500' },
    { label: 'Absent', value: filteredMembers.length - Object.values(attendance).filter(Boolean).length, color: 'text-red-500' },
    { label: 'Visitors', value: 2, color: 'text-blue-500' },
    { label: 'Total', value: filteredMembers.length + 2, color: 'text-purple-500' },
  ];
                ...
                {filteredMembers.map((member) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Avatar>
                        <AvatarFallback className={attendance[member.id] ? 'bg-green-500 text-white' : 'bg-muted'}>
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="visitorPhone" placeholder="+254 7XX XXX XXX" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="visitorEmail">Email</Label>
                      <Input id="visitorEmail" type="email" placeholder="john@example.com" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="visitorNotes">Notes</Label>
                      <Input id="visitorNotes" placeholder="How did they hear about us?" />
                    </div>
                  </div>
                  <DialogFooter>
